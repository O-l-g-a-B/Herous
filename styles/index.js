let json = `[{
    ...
    "pictures": "https://n1s1.hsmedia.ru/13/a5/b2/13a5b2373d5e23489d9a4949ada5b927/547x397_0xac120002_8752067681540468870.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/06/d3/73/06d37321618034ec5f2a65b09c8576e3/547x397_0xac120002_45567661540468871.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/7b/56/08/7b5608ec3df83d872fa1162fb9e32f28/547x397_0xac120002_1773711401540468871.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/37/39/74/373974effcc7ccd093d849e8fa062091/547x397_0xac120002_9548247751540468871.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/41/8f/05/418f050c767eeca8854b328914c7bccc/547x397_0xac120002_20106541761540468871.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/52/a3/e1/52a3e14a0c8f02715b763e7a20fe1c00/547x397_0xac120002_19311926741540468872.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/9a/28/e7/9a28e7b059594fc10387669ae4bd2f22/547x397_0xac120002_20162335021540468872.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/87/ed/c5/87edc525d8813c7b2899e04a4e562fe9/547x397_0xac120002_6444132261540468872.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/e0/2b/55/e02b55b147eeaff9b3fe6bdbb36ff9ea/547x397_0xac120002_744074131540468872.jpg",
    ...
    "pictures": "https://n1s1.hsmedia.ru/34/93/39/3493392c94fc2ae0552ef9c7e87f2617/1034x543_0xac120002_2692921231540468872.jpg",
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    for (let hero of heroes) {
        heroesContent += `<form class="herou card col-sm-6"><h2>${hero.name}</h2><div><span>Вселенная: </span>${hero.universe}</div><div><span>Альтер эго: </span>${hero.alter_ego}</div><div><span>Род деятельности: </span>${hero.occupation}</div><div><span>Друзья: </span>${hero.friends}</div><div><span>Суперсилы: </span>${hero.superpowers}</div><img src="${hero.pictures}"<br><div><span>Подробнее: </span>${hero.more}</div><br><div class="input-group mb-3">
        <label for="grade" class="form-label"><span>Оценка по 10-тибальной системе</span></label><br>
        <input type="number" class="form-control" id="${hero.id}-grade" minlength="1" maxlength="10" required><button type="submit" class="btn btn-secondary btn-sm">Сохранить</button>
      </div></form>`;
        ...
        function retrieveFormValue(event) {
            ...
            const heroGrade = document.getElementById(`${hero.id}-grade`).value;

            if (localStorage.getItem(`${hero.id}-grade`) == null) {
                localStorage.setItem(`${hero.id}-grade`, heroGrade);
            }
        }
    }
    document.getElementById("heroesContainer").innerHTML = heroesContent;

    const grade = localStorage.getItem(`${hero.id}-grade`);
    console.log(grade);
    if (grade != null) {
        document.getElementById(`${hero.id}-grade`).value = grade;
    }
